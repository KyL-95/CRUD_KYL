...
import com.vti.testing.controller.login.LoginInfo;
...
public class UserController {
	...
	public String login(@RequestBody LoginInfo infor) throws IOException {
		return "JWT: " ;
	}
	@GetMapping("/getAll")
...
//	@PreAuthorize("hasAnyRole('ADMIN')")  // Admin mới đc gọi API này
	public User loginInfor(Principal principal) {
		...
		return userService.getByUserName(loginUserName);
